...
struct Nufft3d3Dispatcher {
  ...
  Nufft3d3Dispatcher(const Context &ctx, int iflag, float tol, int numTrans,
      ...
      : m_(safe_cast<int>(x.shape(0))), n_(safe_cast<int>(s.shape(0))),
        numTrans_(safe_cast<int>(numTrans)) {
    check_1d_array(x);
    ...
    plan_ =
        Nufft3d3f(ctx, iflag, tol, numTrans, safe_cast<int>(x.shape(0)),
                  x.data(0), y.data(0), z.data(0), safe_cast<int>(s.shape(0)),
                  s.data(0), t.data(0), u.data(0));
  }
  ...
  Nufft3d3Dispatcher(const Context &ctx, int iflag, double tol, int numTrans,
    ...
    check_1d_array(u, s.shape(0));
    plan_ =
        Nufft3d3(ctx, iflag, tol, numTrans, safe_cast<int>(x.shape(0)),
                 x.data(0), y.data(0), z.data(0), safe_cast<int>(s.shape(0)),
                 s.data(0), t.data(0), u.data(0));
  }
