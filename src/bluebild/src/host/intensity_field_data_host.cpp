...
template auto intensity_field_data_host<float>(
    ...
    std::size_t nEig, const std::complex<float> *s, std::size_t lds,
    const std::complex<float> *w, std::size_t ldw, const float *xyz,
    std::size_t ldxyz, float *d, std::complex<float> *v, std::size_t ldv)
    -> void;

template auto intensity_field_data_host<double>(
    ContextInternal &ctx, double wl, std::size_t m, std::size_t n,
    std::size_t nEig, const std::complex<double> *s, std::size_t lds,
    const std::complex<double> *w, std::size_t ldw, const double *xyz,
    std::size_t ldxyz, double *d, std::complex<double> *v, std::size_t ldv)
    -> void;
